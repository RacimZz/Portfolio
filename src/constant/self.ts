export const selfData = {
  ...
  "En parallèle, j’ai mené de nombreux projets académiques et personnels en IA, analyse de données, programmation logicielle et développement applicatif, et je recherche actuellement un stage de 3 mois et/ou une alternance de 2 ans pour continuer à approfondir ces domaines au sein de projets ambitieux.",
  ],
