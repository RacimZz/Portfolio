export const selfData = {
  ...
  "En parallèle, j’ai mené de nombreux projets académiques et personnels en IA, analyse de données, logiciels systèmes et développement applicatif, et je recherche actuellement un stage et/ou une alternance pour continuer à approfondir ces domaines au sein de projets ambitieux.",
  ],
